...
export class LoadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        // Load the music.
        // TODO: this.load.audio(GG.KEYS.MUSIC.ALL, ['assets/music/SunShineLoopable.mp3', 'assets/music/SunShineLoopable.ogg']);
    }
    ...
    create(): void {
        ...
        ////
        // TODO: GG.soundManager.buildSounds(this);
        // TODO: GG.musicManager.addMusicSound(this.sound.add(GG.KEYS.MUSIC.ALL, { loop: true, volume: GG.SETTINGS.MUSIC_VOLUME }));
